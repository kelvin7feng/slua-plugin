...
cmake -DANDROID_ABI=arm64-v8a -DCMAKE_TOOLCHAIN_FILE=$NDKPATH/build/cmake/android.toolchain.cmake -DANDROID_TOOLCHAIN_NAME=aarch64-linux-android-4.9 -DANDROID_NATIVE_API_LEVEL=android-21 ..
cd ..
...
cmake -DANDROID_ABI=x86 -DCMAKE_TOOLCHAIN_FILE=$NDKPATH/build/cmake/android.toolchain.cmake -DANDROID_TOOLCHAIN_NAME=x86-4.9 -DANDROID_NATIVE_API_LEVEL=android-9 ..
cd ..
